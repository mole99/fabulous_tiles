...
`endif
 ...
 //Side.SOUTH
        ...
        input [15:0] bot2top_DOUT_A,        //Port(Name=bot2top_DOUT_A, IO=INPUT, XOffset=0, YOffset=-1, WireCount=16, Side=SOUTH)
        output [15:0] top2bot_DIN_A,        //Port(Name=top2bot_DIN_A, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=16, Side=SOUTH)
        output [1:0] top2bot_WMASK_A,        //Port(Name=top2bot_WMASK_A, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=2, Side=SOUTH)
        output [3:0] top2bot_ADDR_A,        //Port(Name=top2bot_ADDR_A, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=4, Side=SOUTH)
        input [15:0] bot2top_DOUT_B,        //Port(Name=bot2top_DOUT_B, IO=INPUT, XOffset=0, YOffset=-1, WireCount=16, Side=SOUTH)
        output [3:0] top2bot_ADDR_B,        //Port(Name=top2bot_ADDR_B, IO=OUTPUT, XOffset=0, YOffset=1, WireCount=4, Side=SOUTH)
...
OpenRAM_top_ConfigMem
`ifdef EMULATION
    #(
    .Emulate_Bitstream(Emulate_Bitstream)
    )
`endif
    Inst_OpenRAM_top_ConfigMem
    (
    .FrameData(FrameData),
...
OpenRAM_top_switch_matrix Inst_OpenRAM_top_switch_matrix (
    .N1END0(N1END[0]),
    .N1END1(N1END[1]),
    .N1END2(N1END[2]),
    .N1END3(N1END[3]),
